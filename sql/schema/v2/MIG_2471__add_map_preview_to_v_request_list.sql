-- MIG_2471: Add map_preview_url to v_request_list
--
-- Adds cached map preview URL to the request list view.
-- Depends on MIG_2470 which adds the columns to ops.requests.
--
-- Created: 2026-02-23

\echo ''
\echo '=============================================='
\echo '  MIG_2471: Add Map Preview to v_request_list'
\echo '=============================================='
\echo ''
...
\echo 'View updated with map_preview_url column'

\echo ''
\echo '=============================================='
\echo '  MIG_2471 COMPLETE'
\echo '=============================================='
\echo ''
