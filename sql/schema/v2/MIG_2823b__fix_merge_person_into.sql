-- MIG_2823: Fix merge_person_into() — two bugs
--
-- 1. Referenced ops.communication_logs.person_id which doesn't exist
--    (communication_logs links by submission_id, not person_id)
-- 2. entity_edits.new_value is JSONB but was passed TEXT
--
-- Created: 2026-03-05
-- Related: FFS-158 followup

\echo ''
\echo '=============================================='
\echo '  MIG_2823: Fix merge_person_into()'
\echo '=============================================='
\echo ''
...
BEGIN
  ...
  UPDATE sot.people
  SET merged_into_person_id = p_winner_id, updated_at = NOW()
  WHERE person_id = p_loser_id;
...
\echo 'MIG_2823: merge_person_into() fixed (removed communication_logs, fixed jsonb cast)'
