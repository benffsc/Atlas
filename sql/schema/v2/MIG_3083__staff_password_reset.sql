...
VALUES (
  ...
  ARRAY['staff_first_name', 'reset_url', 'login_url', 'expiry_minutes', 'brand_name', 'org_logo_url', 'brand_full_name', 'org_address', 'org_phone', 'org_website'],
  TRUE
