-- ============================================================================
-- MIG_855: Show active roles in person search subtitles
-- ============================================================================
-- When searching for people in Atlas, the subtitle currently shows
-- "X cats" for everyone. This makes it hard to find specific volunteers,
-- trappers, or staff. This migration updates search_unified() to show
-- active roles (e.g., "Trapper, Volunteer") as the subtitle for people
-- who have them.
-- ============================================================================

\echo ''
\echo '============================================================'
\echo 'MIG_855: Show Active Roles in Person Search Subtitles'
\echo '============================================================'
\echo ''
...
'Unified search across cats, people (including aliases), and places. Returns ranked results with coordinates in metadata for map navigation. MIG_855: Person subtitle now shows active roles instead of cat count.';

\echo ''
\echo 'MIG_855 Changes:'
\echo '  1. Person subtitle shows active roles (Trapper, Volunteer, etc.) instead of cat count'
\echo '  2. Person coordinate lookup prefers resident/owner places over other relationships'
\echo ''
\echo 'Test: SELECT display_name, subtitle FROM trapper.search_suggestions(''crystal'', 5);'
\echo ''
\echo '=== MIG_855 Complete ==='
