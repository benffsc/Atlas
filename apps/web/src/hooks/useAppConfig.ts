...
const DEFAULTS: Record<string, unknown> = {
  ...
  // Clinic kiosk (FFS-1099)
  "kiosk.clinic_tree": null,
  "kiosk.clinic_enabled": true,
  "kiosk.clinic_success_message": "Thank you! Someone will follow up.",
  "kiosk.mission_headline": "We provide free spay/neuter for community cats",
  "kiosk.pet_redirect_message": "For your own pet, these orgs offer low-cost options:",
  "kiosk.trapper_wait_message": "Trapping assistance typically takes 4-8 weeks.",
  "kiosk.welcome_back_enabled": true,
  "kiosk.lobby_modules": null,
  "kiosk.volunteer_qr_url": "https://forgottenfelines.volunteerhub.com/vv2/",
  "kiosk.barn_cat_qr_url": "https://www.forgottenfelines.com/outdoor-app",
  "kiosk.adopt_qr_url": "https://www.forgottenfelines.com/adoption",
  "kiosk.rehome_url": "https://www.forgottenfelines.com/rehome-a-cat",
  "kiosk.deployment_mode": "onsite",
  "kiosk.phone_mode_enabled": false,
