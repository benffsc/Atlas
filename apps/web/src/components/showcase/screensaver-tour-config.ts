...
export const SCREENSAVER_STEPS: ScreensaverStep[] = [
  ...
  // 3. Map: Full picture + open a real place drawer
  {
    ...
    actions: [
      ...
      { type: "select-pin", placeId: DEMO.dartmouth, delay: 19000 },
      { type: "dismiss", delay: 26000 },
      { type: "select-pin", placeId: DEMO.carrAve, delay: 28000 },
      { type: "dismiss", delay: 34000 },
    ],
  },
  // 4. What Beacon does
  {
  ...
  // 6. Map: Corridor Detection (Montecito) — real drawer shows corridor links
  {
    ...
    actions: [
      ...
      { type: "dismiss", delay: 17000 },
      { type: "select-pin", placeId: DEMO.montecito5055, delay: 19000 },
      { type: "dismiss", delay: 26000 },
      { type: "select-pin", placeId: DEMO.montecito5245, delay: 28000 },
      { type: "dismiss", delay: 34000 },
    ],
  },
  // 7. Two levers
  ...
  // 8. Map: Strategic Comparison — 3 areas
  {
    ...
    basemap: "dark" as const,
    actions: [
      { type: "compare-start", delay: 10000 },
      { type: "compare-add-hex", lat: 38.46, lng: -122.81, delay: 12000 },
      { type: "compare-add-hex", lat: 38.35, lng: -122.74, delay: 15000 },
      { type: "compare-add-hex", lat: 38.40, lng: -122.73, delay: 18000 },
      { type: "compare-finish", delay: 20000 },
      { type: "dismiss", delay: 36000 },
    ],
  },
